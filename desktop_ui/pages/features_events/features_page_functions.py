    ...
    def _start_automation():
        ...
        def _run_automation():
            try:
                ...
                # ✅ FIX: Properly schedule completion callback with result
                def _complete():
                    ...
                    if result.get('success'):
                        ...
                        update_status(f"✅ Feature '{feature_name}' created and validated!", 'success')
                        ...
                        validation = result.get('validation', {})
                        reason = validation.get('reason', result.get('error', 'Unknown error'))
                    ...
                    # ✅ Refresh features and auto-select newly created one
                    if on_refresh:
                        on_refresh(new_feature_name=feature_name if result.get('success') else None)
